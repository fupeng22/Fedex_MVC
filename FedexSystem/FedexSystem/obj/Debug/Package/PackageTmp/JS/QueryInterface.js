$(function () {
    ...
    var QueryURL = ""; // "/QueryInterface/GetData?ddlPostion=" + encodeURI(_$_ddlPostion.combotree("getValues").join(',')) + "&ddlCargoProperty=" + encodeURI(_$_ddlCargoProperty.combotree("getValues").join(',')) + "&inputBeginDate=" + encodeURI($("#inputBeginDate").val()) + "&inputEndDate=" + encodeURI($("#inputEndDate").val()) + "&rdViewType=" + encodeURI(viewType) + "&userIds=" + encodeURI(userIds);

    var QueryURL_Depart = "/DepartManagement/GetData?state=open";

    var QueryURL_UserInfo = "/QueryInterface/GetData_UserInfo?strDeptId=-99";

    $("#btnQuery").click(function () {
        //        console.info(encodeURI(_$_ddlPostion.combotree("getValues").join(',')));
        //        return false;
        ...
        QueryURL = "/QueryInterface/GetData?ddlPostion=" + encodeURI(_$_ddlPostion.combotree("getValues").join(',')) + "&ddlCargoProperty=" + encodeURI(_$_ddlCargoProperty.combotree("getValues").join(',')) + "&inputBeginDate=" + encodeURI($("#inputBeginDate").val()) + "&inputEndDate=" + encodeURI($("#inputEndDate").val()) + "&rdViewType=" + encodeURI(viewType) + "&userIds=" + encodeURI(userIds) + "&hid_IsEmployee=" + encodeURI($("#hid_IsEmployee").val());
    ...
    $("#btnPrint").click(function () {
        PrintURL = "/QueryInterface/Print?ddlPostion=" + encodeURI(_$_ddlPostion.combotree("getValues").join(',')) + "&ddlCargoProperty=" + encodeURI(_$_ddlCargoProperty.combotree("getValues").join(',')) + "&inputBeginDate=" + encodeURI($("#inputBeginDate").val()) + "&inputEndDate=" + encodeURI($("#inputEndDate").val()) + "&rdViewType=" + encodeURI(viewType) + "&userIds=" + encodeURI(userIds) + "&hid_IsEmployee=" + encodeURI($("#hid_IsEmployee").val()) + "&order=" + _$_datagrid.datagrid("options").sortOrder + "&sort=" + _$_datagrid.datagrid("options").sortName + "&page=1&rows=10000000";
    ...
    $("#btnExcel").click(function () {
        ...
        PrintURL = "/QueryInterface/Excel?ddlPostion=" + encodeURI(_$_ddlPostion.combotree("getValues").join(',')) + "&ddlCargoProperty=" + encodeURI(_$_ddlCargoProperty.combotree("getValues").join(',')) + "&inputBeginDate=" + encodeURI($("#inputBeginDate").val()) + "&inputEndDate=" + encodeURI($("#inputEndDate").val()) + "&rdViewType=" + encodeURI(viewType) + "&userIds=" + encodeURI(userIds) + "&hid_IsEmployee=" + encodeURI($("#hid_IsEmployee").val()) + "&order=" + _$_datagrid.datagrid("options").sortOrder + "&sort=" + _$_datagrid.datagrid("options").sortName + "&page=1&rows=10000000&browserType=" + browserType;
        if (_$_datagrid.datagrid("getData").rows.length > 0) {
    ...
    _$_TVDepart.tree({
        ...
        onClick: function (node) {
            ...
            QueryURL_UserInfo = "/QueryInterface/GetData_UserInfo?strDeptId=" + encodeURI(node.id);
            window.setTimeout(function () {
